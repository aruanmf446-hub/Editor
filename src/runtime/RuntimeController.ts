...
export class RuntimeController {
  ...
  constructor(private readonly options: Options) {
    ...
    this.world = {
      ...
      requiredCollectiblesRemaining: snapshot.initialScene.objects.filter((object) => object.type === 'collectible' && object.visible && !object.editorOnly && object.collectibleRequired).length,
      activeDialogue: null,
